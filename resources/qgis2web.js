...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [6606066.498618, 2783387.384396, 8798629.460585, 3836371.808469], maxZoom: 28, minZoom: 1, projection: new ol.proj.Projection({
            code: 'EPSG:3857',
            //extent: [6778450.403377, 2863123.730610, 7825282.931026, 3776258.934152],
            units: 'm'})
    })
});

//initial view - epsg:3857 coordinates if not "Match project CRS"
map.getView().fit([6606066.498618, 2783387.384396, 8798629.460585, 3836371.808469], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Benazir Income Support Programme </h2>';
        return titleElement;
    })(),
...
var searchLayer = new SearchLayer({
    layer: lyr_BISPBalOfficesandFocalPersonwithlatitudeandlogitudeMar122026_3,
    colName: 'Tehsil',
    zoom: 10,
    collapsed: true,
    map: map,
